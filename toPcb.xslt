...
-->
<xsl:template match="fp_line[layer/@val = 'F.SilkS']">	ElementLine[ <xsl:value-of select="start/@x"/>mm <xsl:value-of select="start/@y"/>mm <xsl:value-of select="end/@x"/>mm <xsl:value-of select="end/@y"/>mm <xsl:value-of select="width/@val"/>mm ]
</xsl:template>
<xsl:template match="fp_line[layer/@val = 'F.CrtYd']">	ElementLine[ <xsl:value-of select="start/@x"/>mm <xsl:value-of select="start/@y"/>mm <xsl:value-of select="end/@x"/>mm <xsl:value-of select="end/@y"/>mm <xsl:value-of select="width/@val"/>mm ]
</xsl:template>
...
<xsl:template match="pad[@type='smd']">	Pad [ <xsl:value-of select="at/@x -(size/@w div 2) + (size/@h div 2)"/>mm <xsl:value-of select="at/@y"/>mm <xsl:value-of select="at/@x + (size/@w div 2) -(size/@h div2) "/>mm <xsl:value-of select="at/@y"/>mm <xsl:value-of select="size/@h"/>mm 8mil <xsl:value-of select="size/@h + 0.3"/>mm  "<xsl:value-of select="@number"/>" "<xsl:value-of select="@number"/>" "square" ]</xsl:template>
